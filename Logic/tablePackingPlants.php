...
$columns = array(
    ...
    array('db' => 'dry_method', 'dt' => 'td_dry_method',),
    array(
        'db' => 'dry_method', 'dt' => 'td_dry_method_name',
        'formatter' => function ($d, $row) {
            $p_general = new General();
            $dryMethodInfo = $p_general->getValueOfAnyTable('dry_method', 'id', '=', $d);
            $dryMethodInfo = $dryMethodInfo->results();
            return  $dryMethodInfo[0]->name;
        }
    ),

    array('db' => 'trimming_method', 'dt' => 'td_trimming_method',),
    array(
        'db' => 'trimming_method', 'dt' => 'td_trimming_method_name',
        'formatter' => function ($d, $row) {
            $p_general = new General();
            $dryMethodInfo = $p_general->getValueOfAnyTable('trimming_method', 'id', '=', $d);
            $dryMethodInfo = $dryMethodInfo->results();
            return  $dryMethodInfo[0]->name;
        }
    ),
