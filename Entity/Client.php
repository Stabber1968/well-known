...
class Client {
    ...
    public function find($id = null) {
        if($id) {
            ...
            $data = $this->_db->get('client', array('id', '=', $id));
    ...
    public function getAllOfInfo(){
        ...
        $data = $this->_db->get('client', array('1', '=', '1'));
        if($data->count()) {
            $this->_data = $data->first();
            $this->_count = $data->count();
        }
    ...
    public function delete($id){
        return $this->_db->delete('client', array('id', '=', $id));
    }
    ...
    public function isSame($name) {
        if($name) {
            $data = $this->_db->get('client', array('name', '=', $name));
