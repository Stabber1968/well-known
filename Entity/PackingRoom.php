...
class PackingRoom {
    ...
    public function create($fields = array()) {
        ...
        if(!$this->_db->insert('room_packing', $fields)) {
            throw new Exception('There was a problem creating this room.');
        }
    }
    ...
    public function update($fields = array(), $id = null) {
        if(!$this->_db->update('room_packing', $id, $fields)) {
    ...
    public function isSame($name) {
        if($name) {
            $data = $this->_db->get('room_packing', array('name', '=', $name));
