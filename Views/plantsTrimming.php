...
if($_GET['room']){
    ...
    $lotIDList = $p_general->getValueOfAnyTable('index_trimming','room_id','=',$trimmingRoomID);
    $lotIDList = $lotIDList->results();
}else{
    $lotIDList = $p_general->getValueOfAnyTable('index_trimming','1','=','1');
    $lotIDList = $lotIDList->results();
}
        ...
        <div class="modal-content">
            ...
            <div class="row modal-body">
                <div class="col-12 col-sm-6">
                    <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="editDryPlantFormValidate">
                        <!--body-->
                                    ...
                                    <div class="col-7">
                                        <div class="form-group">
                                            <select class="form-control select2bs4" name="location" id="location" style="width: 100%;">
                                                ...
                                                <?php
                                                $mTrimmingRoomList = $p_general->getValueOfAnyTable('room_trimming','1','=','1');
                                                $mTrimmingRoomList = $mTrimmingRoomList->results();
                                                foreach($mTrimmingRoomList as $mTrimmingRoom){
                                                    ?>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="row modal-body">
                        <!-- sample form -->
                        <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="sampleForm" style="width:100%;">
                                <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- Pesticide form -->
                        <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="pestForm" style="width: 100%;" >
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- weight form -->
                        <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="weightForm" style="width:100%;">
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- Waste form -->
                        <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="wasteForm" style="width:100%;">
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- delete form -->
                        <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="deleteForm" >
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
    ...
    <div class="modal-dialog width-modal-dialog-transfer-plants">
        <div class="modal-content">
            ...
            <form method="post" action="../Logic/saveTrimmingPlants.php" enctype='multipart/form-data' id="trimmingTransferFormValidate">
                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control select2bs4" name="start_lot_ID" name="start_lot_ID" id="start_lot_ID" style="width: 100%;">
                                        ...
                                        if($mLotList) {
                                            ...
                                            foreach ($mLotList as $mLot) {
                                                $exist = $p_general->getValueOfAnyTable('index_trimming','lot_id','=',$mLot->lot_ID,'lot_id');
                                                $exist = $exist->results();
                                                if($exist){
                                                    ?>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="packing_room_ID" id="packing_room_ID" style="width: 100%;">
                                        <option value="" >Select Packing Room</option>
                                        <?php
                                        $packingRoomList = $p_general->getValueOfAnyTable('room_packing','1','=','1');
                                        $packingRoomList = $packingRoomList->results();
                                        foreach($packingRoomList as $packingRoom){
                                            ?>
                                            <option value="<?=$packingRoom->id?>" ><?=$packingRoom->name?></option>
                            ...
                            <div class="col-10">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="trimming_method" id="trimming_method" style="width: 100%;">
                                        ...
                                        <?php
                                        $trimmingMethodtList = $p_general->getValueOfAnyTable('trimming_method','1','=','1');
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" id ="btn_transferAction" class="btn btn-primary" value="Transfer to Packing Room">Transfer to Packing Room</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-outline-light" id="btn_delete_1">Yes</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" name="start_lot_ID_print" id="start_lot_ID_print" style="width: 100%;">
                                <option value="" >Select Lot ID</option>
                                <?php
                                $LotIDList = $p_general->getValueOfAnyTable('index_trimming','1','=','1','lot_id');
                                $LotIDList = $LotIDList->results();
...
<script>
    ...
    $( document ).ready( function () {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "../Logic/tableTrimmingPlants.php",
                "data": {
