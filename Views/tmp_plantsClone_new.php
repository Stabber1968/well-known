                            ...
                            <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th >mother id</th>
                                        <th>Mother ID</th>
                                        <th >mother id exist on mother room</th>
                                        <th >Location ID</th>
                                        <th>Location</th>
                                        <th>Born Date</th>
                                        <th>Days</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn_printQRCode', function() {
            ...
            setTimeout(
                function() {
                    ...
                    document.getElementById("print_id").innerHTML = plant_UID_text;
        ...
        var table = $('#example1').DataTable({
            "processing": true,
            "serverSide": true,
            "sAjaxSource": "../Logic/tableClonePlants.php",
            order: [1, 'asc'],
            "aoColumnDefs": [{
                    "bVisible": true,
                    "aTargets": [1]
