...
$mFlowerRoomList = $rFlower->getAllOfInfo();
$mFlowerRoomList = $mFlowerRoomList->results();

$pFlower = new FlowerPlant();
if ($_GET['room']) {
    $flowerRoomID = $_GET['room'];
    $plantsIDList = $pFlower->getPlantsListFromFlowerRoomID($flowerRoomID);
} else {
    $plantsIDList = $p_general->getValueOfAnyTable('index_flower', '1', '=', '1', 'plant_id');
    ...
    <div class="card card-primary card-outline card-outline-tabs ml-3 mr-3">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="flower" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="flower_plants_tab" data-toggle="pill" href="#flower_plants_content" role="tab" aria-controls="flower_plants_tab" aria-selected="true">Flower Plants</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="flower_rooms_tab" href="roomsFlower.php">Flower Rooms</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="tab-pane fade show active" id="flower_plants_content" role="tabpanel" aria-labelledby="flowerflower_plants_content">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <input name="currentRoomID" id="currentRoomID" type="hidden" value="<?= $flowerRoomID ?>">
                                        <select class="form-control select2bs4" id="selectedFlowerRoomID" style="width: 100%;">
                                            <option value="0">All Flower Room</option>
                                            <?php
                                            if ($mFlowerRoomList) {
                                                $k = 0;
                                                foreach ($mFlowerRoomList as $mFlowerRoom) {
                                            ?>
                                                    <option <?php
                                                            if ($flowerRoomID == $mFlowerRoom->id) {
                                                                echo 'selected';
                                                            }
                                                            ?> value="<?= $mFlowerRoom->id ?>"><?= $mFlowerRoom->name ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <select class="form-control select2bs4" id="selectedLotID" style="width: 100%;">
                                            ...
                                            if ($mLotList) {
                                                ...
                                                foreach ($mLotList as $mLot) {
                                                    $exist = $p_general->getValueOfAnyTable('index_flower', 'lot_id', '=', $mLot->lot_ID);
                                                    $exist = $exist->results();
                                                    if ($exist) {
                                            ?>
                                                        <option <?php
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="td_location"><?php
                                                                    $roomInfo = $p_general->getValueOfAnyTable('room_flower', 'id', '=', $plantInfo[0]->location);
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                <a class="btn bg-gradient-green btn-sm" id="btn_editFlowerPlant" data-target="#modal-edit" href="#modal-edit" data-toggle="modal">
    ...
    <div class="modal-dialog width-modal-large">
        <div class="modal-content">
            ...
            <div class="row modal-body">
                ...
                <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="LotFormValidate">
                    <div class="modal-body">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-5"><label>Transfer to</label></div>
                                <div class="col-7">
                                <select class="form-control select2bs4" name="location_create" id="location_create" style="width: 100%;">
                                    ...
                                    <?php
                                    $roomVegList = $p_general->getValueOfAnyTable('room_flower', '1', '=', '1');
                            ...
                            <div id="qr_code_section" hidden class="row">
                                <div class="col-5">
                                <label>QR code</label>
                                </div>
                                <div class="col-7">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group input-group mb-3">
                                        <textarea class="form-control" rows="7" placeholder="Enter ..." id="note_create" name="note_create" style="height: 150px"></textarea>
                                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="btn_save_edit" value="Save">Save</button>
                    </div>
                </form>
                </div>
                <div class="col-12 col-sm-6">
                    ...
                    <div class="row modal-body">
                        <!-- sample form -->
                        <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="sampleForm" style="width:100%;">
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- Pesticide form -->
                        <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="pestForm" style="width: 100%;" >
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- weight form -->
                        <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="weightForm" style="width:100%;">
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- Waste form -->
                        <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="wasteForm" style="width:100%;">
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
                        ...
                        <!-- delete form -->
                        <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="deleteForm" >
                            <!-- <div class="modal-body"> -->
                                <fieldset>
                                    <input name="id" id="id" type="hidden" value="">
...
<div class="modal fade" id="modal-transfer">
    <div class="modal-dialog width-modal-transfer-type">
        <div class="modal-content">
            <!--header-->
            <div class="modal-header">
                <h4 class="modal-title">Transfer to Drying Room</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <!-- <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="flowerTrnasferFormValidate"> -->
                <!--body-->
                <div class="modal-body">
                    <div class="row " style="text-align: center">
                        <div class="col-6">
                            <a class="btn bg-gradient-green btn-md" href="#" id="btn_createNewCompoundLotID" data-dismiss="modal">
                                <i class="fas fa-paper-plane"></i>
                                Creat a New compound Lot Id
                            </a>
                        </div>
                        <div class="col-6">
                            <a class="btn bg-gradient-primary btn-md" href="#" id="btn_transferSingleLotID" data-dismiss="modal">
                                <i class="fas fa-paper-plane"></i>
                                Transfer single Lot Id
                            </a>
                        </div>
                    </div>
                </div>
...
<!-- Modal transfer single lot id -->
<div class="modal fade" id="modal-transfer-single_lot">
    <div class="modal-dialog width-modal-dialog-transfer-plants">
        <div class="modal-content">
            ...
            <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="flowerTrnasferFormValidate">
                ...
                <div class="modal-body">
                    <fieldset>
                        <input name="act" id="act" type="hidden" value="transfer_single_lot">
                        <input name="trans_s_adminID" id="trans_s_adminID" type="hidden" value="">
                        <div class="row">
                            <div class="col-1"></div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="start_lot_ID" name="start_lot_ID" id="start_lot_ID" style="width: 100%;">
                                        ...
                                        if ($mLotList) {
                                            $k = 0;
                                            foreach ($mLotList as $mLot) {
                                                $exist = $p_general->getValueOfAnyTable('index_flower', 'lot_id', '=', $mLot->lot_ID, 'lot_id');
                                                $exist = $exist->results();
                                                if ($exist) {
                                        ?>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="dry_room_id" id="dry_room_id" style="width: 100%;">
                                        <option value="">Select Drying Room</option>
                                        <?php
                                        $roomDryList = $p_general->getValueOfAnyTable('room_dry', '1', '=', '1');
                                        $roomDryList = $roomDryList->results();
                                        foreach ($roomDryList as $roomDry) {
                                        ?>
                                            <option value="<?= $roomDry->id ?>"><?= $roomDry->name ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" id="btn_transferAction" class="btn btn-primary" value="Transfer To Dry Room">Transfer To Dry Room</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Modal Transfer New compound Lot ID -->
<div class="modal fade" id="modal-transfer-compound_lot">
    <div class="modal-dialog width-modal-large">
        <div class="modal-content">
            <!--header-->
            <div class="modal-header">
                <h4 class="modal-title">Transfer to Dry Room</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <!--TODO-->
            <form method="post" action="../Logic/saveFlowerPlants.php" enctype='multipart/form-data' id="createNewCompoundFormValidate">
                <div class="modal-body">
                    <fieldset>
                        <input name="id" id="id" type="hidden" value="">
                        <input name="act" id="act" type="hidden" value="transfer_compound_lot">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label>Genetic</label>
                                    <select class="form-control select2bs4" name="genetic_id_transfer_compound" id="genetic_id_transfer_compound" style="width: 100%;">
                                        <option value="">Select Genetic</option>
                                        <?php
                                        $geneticList = $p_general->getValueOfAnyTable('genetic', '1', '=', '1', 'id');
                                        $geneticList = $geneticList->results();
                                        foreach ($geneticList as $genetic) {
                                            $exist = $p_general->getValueOfAnyTable('index_flower', 'genetic_id', '=', $genetic->id);
                                            $exist = $exist->results();
                                            if ($exist) {
                                        ?>
                                                <option value="<?= $genetic->id ?>"><?= $genetic->genetic_name ?></option>
                                ...
                                <div class="form-group">
                                    <label>Lot ID</label>
                                    <select class="form-control select2bs4" multiple="multiple" data-placeholder="Select Lot ID" name="compound_lotID_list[]" id="compound_lotID_list" style="width: 100%;">
                                    </select>
                                </div>

                                <label>New compound Lot ID</label>
                                <div class="form-group input-group mb-3">
                                    <input type="hidden" class="form-control" id="lot_ID_transfer_compound" name="lot_ID_transfer_compound">
                                    <input type="text" class="form-control" placeholder="Lot ID" id="lot_ID_text_transfer_compound" name="lot_ID_text_transfer_compound" autocomplete="off" readonly>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span class="fas fa-user"></span>
                                        </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group input-group mb-3">
                                    <div class="input-group date" id="reservationdate_1" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate_1" id="born_date_compound" name="born_date_compound" />
                                        <div class="input-group-append" data-target="#reservationdate_1" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="dry_room_id_transfer_compound" id="dry_room_id_transfer_compound" style="width: 100%;">
                                        <option value="">Select Dry Room</option>
                                        <?php
                                        $roomVegList = $p_general->getValueOfAnyTable('room_dry', '1', '=', '1');
                                        $roomVegList = $roomVegList->results();
                                        foreach ($roomVegList as $roomVeg) {
                                        ?>
                                            <option value="<?= $roomVeg->id ?>"><?= $roomVeg->name ?></option>
                                ...
                                <label>Note</label>
                                <div class="form-group input-group mb-3">
                                    <textarea class="form-control" rows="3" placeholder="Enter ..." id="note_transfer_compound" name="note_transfer_compound" style="height: 50px"></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" value="Transfer To Dry Room" id="btn_multi_transferAction">Transfer To Dry Room</button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" name="start_lot_ID_print" id="start_lot_ID_print" style="width: 100%;">
                                <option value="">Select Lot ID</option>
                                <?php
                                $LotIDList = $p_general->getValueOfAnyTable('index_flower', '1', '=', '1', 'lot_id');
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn_sample', function() {
            ...
            $.ajax({
                method: 'GET',
                url: '../Logic/saveFlowerPlants.php',
                data: {
                    act: 'sample',
                    date: today,
        ...
        //TODO
        $('#genetic_id_transfer_compound').change(function() {
            var selectedGeneticID = $(this).val();
            if (selectedGeneticID) {
                $('#compound_lotID_list').empty();
                $.ajax({
                    method: 'POST',
                    url: '../Logic/saveFlowerPlants.php',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $.each(obj, function(key, value) {
                            var data = {
                                lot_id: value['lot_id'],
                                lot_id_text: value['lot_id_text']
                            };
                            var newOption = new Option(data.lot_id_text, data.lot_id, false, false);
                            $('#compound_lotID_list').append(newOption).trigger('change');
                        });
                    }
                })
            } else {
        ...
        //Click transfer with single Lot ID
        $('#btn_transferSingleLotID').click(function() {
            //show Modal
            $("#modal-transfer-single_lot").modal('show');
        });

        //Click transfer with Create New compound Lot ID
        $('#btn_createNewCompoundLotID').click(function() {
            //get Current Date
            var currentDate = _getCurrentDate();
            $('#born_date_compound').val(currentDate); // lotID born date
            // ...
            // generate new lot id
            $.ajax({
                method: 'POST',
                ...
                success: function(data) {
                    ...
                    /*
                     ...
                     obj[1] : $lot_ID_text
                     */
                    $('#lot_ID_transfer_compound').val(obj[0]);
                    $('#lot_ID_text_transfer_compound').val(obj[1]);
                }
            })
            // ...

            //show Modal
            $("#modal-transfer-compound_lot").modal('show');
        });
        ...
        $('#start_lot_ID').change(function() {
            ...
            if (selectedID) {
                for (var i = 0; i < cnt; i++) {
                    ...
                    if (parseInt(value) >= parseInt(selectedID)) {
        ...
        var table = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "../Logic/tableFlowerPlants.php",
                "data": {
            ...
            $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (obj == 'faild') {
                            ...
                            if(act == 'single') {
                                $('#trans_s_adminID').val(admin_id);
                                $('#flowerTrnasferFormValidate').submit();
                            } else if(act == 'multi') {
                                $('#trans_adminID').val(admin_id);
                                $('#createNewCompoundFormValidate').submit();
                            }
                            else if(act == 'delete') {
        ...
        //click add Flower plant
        $("#btn_addFlowerPlant").click(function() {
            var act = "add"
            //get Current Date
            var currentDate = _getCurrentDate();
            ...
            //hidden QR code input section when create Flower plants
        ...
        $('#modal-edit').on('hidden.bs.modal', function() {
            ...
            $("#plant_UID_text").val("");
            $("#quantity").val("");
            //Show QR code input section when create Flower plants
            $("#qr_code_section").prop("hidden", false);
        ...
        $('#modal-transfer-single_lot').on('hidden.bs.modal', function() {
        ...
        $("#btn_saveFlowerPlant").click(function() {
            ...
            if (act == 'add') {
                if (qr_code) {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: '../Logic/saveFlowerFlowerPlants.php',
                        data: {
                            act: 'validate',
                            qr_code: qr_code
                        },
                        success: function(data) {
                            ...
                            if (obj == 'SameQRCode') {
                                ...
                                $('#ediFlowerFlowerPlantFormValidate').submit();
                            }
                        }
                    })
                }
            ...
            if (act == 'edit') {
                $('#editFlowerPlantFormValidate').submit();
            }
            return false;
        })

        //Change Event of select box (VFlowerFlowerg Room)
        $('#selectedFlowerRoomID').on('change', function() {
            var flowerRoomID = this.value;
            var selectedLotID = $('#selectedLotID').val();

            if (flowerRoomID == 0) {
                $.redirect('../Views/plantsFlower.php');
            } else {
                $.redirect('../Views/plantsFlower.php', {
                        room: flowerRoomID,
                        lot: selectedLotID
        ...
        $('#selectedLotID').on('change', function() {
            var FlowerRoomID = $('#selectedFlowerRoomID').val();
